...
rmse_1 <- sqrt(mean((prediction$data$truth-prediction$data$response)^2))
rmse_1
...
rmse_2 <- sqrt(mean((prediction$data$truth-prediction$data$response)^2))
rmse_2
...
rmse_3 <- sqrt(mean((prediction$data$truth-prediction$data$response)^2))
rmse_3
